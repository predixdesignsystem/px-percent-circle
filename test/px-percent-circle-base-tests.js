...
function runBaseTests() {
  px_percent_circle_1 = document.getElementById('px-percent-circle-1');

  suite('Base Automation Tests for px-percent-circle', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-percent-circle fixture is created', function() {
      assert.isTrue(document.getElementById('px-percent-circle-1') !== null);
    });
